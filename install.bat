...
set REPO_URL=https://github.com/voewoda88/VirtualAssistant
set umamba_exists=F
...
if exist VirtualAssistant\ (
  cd VirtualAssistant
  git pull
) else (
  git clone https://github.com/voewoda88/VirtualAssistant
  cd VirtualAssistant || goto end
)
